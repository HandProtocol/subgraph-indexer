import {
  ...
  ScoreTypeAdded as ScoreTypeAddedEvent,
  ScoreTypeRemoved as ScoreTypeRemovedEvent,
...
export function handleScoreTypeAdded(event: ScoreTypeAddedEvent): void {
  let entity = new ScoreTypeAdded(
    event.transaction.hash.concatI32(event.logIndex.toI32())
  )
  entity.scoreType = event.params.scoreType
...
export function handleScoreTypeRemoved(event: ScoreTypeRemovedEvent): void {
  let entity = new ScoreTypeRemoved(
    event.transaction.hash.concatI32(event.logIndex.toI32())
  )
  entity.scoreType = event.params.scoreType
